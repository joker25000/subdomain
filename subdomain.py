...
print " _____       _         _                       _       "
print "/  ___|     | |       | |                     (_)      "
print "\ `--. _   _| |__   __| | ___  _ __ ___   __ _ _ _ __  "
print " `--. \ | | | '_ \ / _` |/ _ \| '_ ` _ \ / _` | | '_ \ \033[94m "
print "/\__/ / |_| | |_) | (_| | (_) | | | | | | (_| | | | | |"
print "\____/ \__,_|_.__/ \__,_|\___/|_| |_| |_|\__,_|_|_| |_|\033[91m "
print "-----------=[ Searching \033[91mdomain/\033[94msubdomain ]=-----------"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  
print "          ....................................\033[94m "
print "          .  [+] \033[91mCoder :\033[94mJoker-Security       ."
print "          . [+] \033[91mWebsite :\033[94mhttp://dev-labs.co  ."
print "          .[+] \033[91mGithub :\033[94mgithub.com/joker25000 . "
print "          ....................................  " 
...
def results(algeria):
	with open ('resultat.txt','w') as k:
		json.dump(algeria,k)
print "[*] \033[91mExmple:\033[94m"
print "python subdomain.py -t gmail.com -l fr \n\n\t"
